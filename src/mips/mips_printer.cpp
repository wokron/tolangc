...
void ArgumentReg::PrintReg(std::ostream &out) {
    out << "$a" << GetIndex();
}

void ValueReg::PrintReg(std::ostream &out) {
    out << "$v" << GetIndex();
}
...
void FloatReg::PrintReg(std::ostream &out) {
    out << "$f" << GetIndex();
}

void RetAddrReg::PrintReg(std::ostream &out) {
    out << "$ra";
}

void StkPtrReg::PrintReg(std::ostream &out) {
    out << "$sp";
}

void FrmPtrReg::PrintReg(std::ostream &out) {
    out << "$fp";
}

void OffsetReg::PrintReg(std::ostream &out) {
    out << GetIndex();
}

void WordData::printValue(std::ostream &out) {
    out << w_value;
}
...
void FloatData::printValue(std::ostream &out) {
    out << f_value;
}
